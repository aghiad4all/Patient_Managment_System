...
namespace _430P
{
    ...
    public partial class Form11 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string marital = textBox4.Text.ToString();
            string enumb = textBox5.Text.ToString();
            string email = textBox6.Text.ToString();
            string password = textBox7.Text.ToString();
            string query;
            if (username.Equals("") || address.Equals("") || phonenum.Equals("") || marital.Equals("") || enumb.Equals("") || email.Equals("") || password.Equals(""))
            {
            ...
            else
            {
                ...
                try
                {
                    ...
                    conn8.Open();
                    query = "UPDATE Patient SET Address= '" + address + "'" + ",PhoneNum='" + phonenum + "',Marital='" + marital + "',EmergencyNum='" + enumb + "',Email='" + email + "',Password='" + password + "' WHERE Username= '" + username + "'";
